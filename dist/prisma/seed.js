...
async function main() {
    ...
    const post1 = await prisma.post.create({
        data: {
            ...
            content: "TypeScript is a powerful superset of JavaScript that adds static type checking. In this post, we'll explore the basics of TypeScript and how it can improve your development workflow...",
            images: [
    ...
    const post2 = await prisma.post.create({
        data: {
            ...
            content: "Express.js is a minimal and flexible Node.js web application framework. Today, I'll share best practices for building scalable and maintainable APIs...",
            images: [
    ...
    const post3 = await prisma.post.create({
        data: {
            ...
            content: "Prisma is a next-generation ORM that makes working with databases easy. Let's dive into schema design, migrations, and best practices...",
            images: [
